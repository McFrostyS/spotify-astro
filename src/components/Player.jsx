  ...
  return (
    <div className='flex justify-center gap-x-2'>
      <button className='opacity-70 hover:opacity-100 transition' onClick={handleVolume}>
        {isVolumeSilence ? <VolumeSilence /> : isVolumeLow ? <VolumeLow /> : <Volume />}
      </button>
      <Slider
        defaultValue={100}
        max={100}
...
export function Player() {
  const { currentMusic, isPlaying, setIsPlaying, setNextSong, setPreviousSong, volume } =
  ...
  return (
    <div className='flex flex-row justify-between w-full px-1 z-50'>
      ...
      <div className='grid place-content-center mt-4 mr-7'>
        <VolumeControl />
      </div>
